...
print("Dear all, sincere apologies. Due to circumstances beyond our control, we can only invite two guests for dinner.")

popped_guest_7 = guests.pop()
print(f"Dear {popped_guest_7}, we're sorry that we couldn't invite you for dinner.")
popped_guest_6 = guests.pop()
print(f"Dear {popped_guest_6}, we're sorry that we couldn't invite you for dinner.")
popped_guest_5 = guests.pop()
print(f"Dear {popped_guest_5}, we're sorry that we couldn't invite you for dinner.")
popped_guest_4 = guests.pop()
print(f"Dear {popped_guest_4}, we're sorry that we couldn't invite you for dinner.")
popped_guest_3 = guests.pop()
print(f"Dear {popped_guest_3}, we're sorry that we couldn't invite you for dinner.")

print(f"Dear {guests[0]}, you are still invited to dinner at the home of Welile Zambodla.")
print(f"Dear {guests[1]}, you are still invited to dinner at the home of Welile Zambodla.")
